...
export type AuditLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "action" | "entityType" | "entityId" | "organizationId" | "actorUserId" | "metadata" | "correlationId" | "occurredAt", ExtArgs["result"]["auditLog"]>;
